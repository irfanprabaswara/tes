...
{//awal kelas
  ...
  {//awal fungsi
    ...
    $message="*APA YANG AKAN ANDA LAKUKAN?*";
		$inlineLayout = [[
			Keyboard::inlineButton(['SET PENUGASAN' => 'Our site', 'callback_data' => 'setPenugasan']),
			Keyboard::inlineButton(['SET SELESAI BERTUGAS' => 'Contact Us', 'callback_data' => 'setSelesaiBertugas'])
		]];
